 ...
 */
export type AgentToolExecute<T = Record<string, unknown>> = (toolCallId: string, params: T, signal?: AbortSignal, onUpdate?: (partial: unknown) => void) => Promise<AgentToolResult>;
/**
...
export type HookEvent = 'beforeAgentStart' | 'afterAgentStart' | 'beforeAgentEnd' | 'agentEnd' | 'beforeToolCall' | 'afterToolCall' | 'messageReceived' | 'messageSent';
...
export interface OpenClawPluginApi {
     ...
     */
    registerCli: (callback: CliRegistrationCallback, opts?: {
        commands?: string[];
    }) => void;
    /**
