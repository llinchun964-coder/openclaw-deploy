 ...
 */
export function createFileShareTool(options) {
    const { client, logger, user_id } = options;
    return {
        name: 'file_share',
        description: 'Generate a shareable download link for a file. Use when you need to share a file with someone outside the system. ' +
        ...
        async execute(params) {
            ...
            try {
                // Call API
                const response = await client.post(`/files/${file_id}/share`, {
                    expires_in,
                    max_downloads,
                }, { user_id });
                if (!response.success) {
