...
import { createBoundaryMarkers, detectInjectionPatternsAsync, sanitizeMessageForContext, sanitizeMetadataField, } from '../utils/injection-protection.js';
/** Channel type enum */
    ...
    return {
        ...
        async execute(params) {
            ...
            try {
                ...
                const response = await client.get(`/threads?${queryParams}`, { user_id });
                if (!response.success) {
    ...
    return {
        ...
        async execute(params) {
            ...
            try {
                ...
                const response = await client.get(`/threads/${thread_id}/history?${queryParams}`, { user_id });
                if (!response.success) {
