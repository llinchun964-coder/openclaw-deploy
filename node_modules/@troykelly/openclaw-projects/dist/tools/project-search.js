 ...
 */
export function createProjectSearchTool(options) {
    const { client, logger, config, user_id } = options;
    return {
        name: 'project_search',
        description: 'Search projects by natural language query. Uses semantic and text search to find relevant projects. ' +
        ...
        async execute(params) {
            ...
            try {
                ...
                const response = await client.get(`/search?${queryParams.toString()}`, { user_id });
                if (!response.success) {
