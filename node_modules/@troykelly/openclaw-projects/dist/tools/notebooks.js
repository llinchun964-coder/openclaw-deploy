...
export function createNotebookListTool(options) {
    ...
    return {
        name: 'notebook_list',
        description: 'Lists available notebooks for the user. Use to find notebook IDs before creating or organizing notes. Returns notebook names, descriptions, and note counts. Read-only.',
        ...
        async execute(params) {
            ...
            try {
                ...
                const response = await client.get(`/notebooks?${queryParams}`, { user_id, user_email: user_id });
                if (!response.success) {
...
export function createNotebookCreateTool(options) {
    ...
    return {
        ...
        description: 'Creates a new notebook to organize notes into collections. Use for grouping related notes (e.g., "Meeting Notes", "Research"). Persists the notebook. Use notebook_list to check for existing notebooks first.',
        ...
        async execute(params) {
            ...
            try {
                const response = await client.post('/notebooks', {
                    user_email: user_id,
                    name: sanitizedName,
...
export function createNotebookGetTool(options) {
    ...
    return {
        name: 'notebook_get',
        description: 'Gets a notebook by its ID with optional expansion to include contained notes. Only accessible if you own the notebook or have shared access. Read-only.',
        ...
        async execute(params) {
            ...
            try {
                ...
                const response = await client.get(`/notebooks/${notebook_id}?${queryParams}`, { user_id, user_email: user_id });
                if (!response.success) {
