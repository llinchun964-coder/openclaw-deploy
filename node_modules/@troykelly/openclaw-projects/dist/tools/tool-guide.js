 ...
 */
import { z } from 'zod';
import { TOOL_CATALOG, GROUP_CATALOG } from '../tool-guidance/catalog.js';
 ...
 */
function scoreToolForTask(toolName, guidance, queryTokens) {
 ...
 */
function formatToolGuidance(toolName, guidance) {
    const lines = [
        `## ${toolName}`,
 ...
 */
function formatGroupGuidance(groupName, groupInfo) {
    const lines = [
        `## Group: ${groupName}`,
        '',
 ...
 */
export function createToolGuideTool() {
    return {
        name: 'tool_guide',
        description: 'Get usage guidance for tools. Call with a tool name for detailed guidance, a group name for group overview, a task description for recommendations, or no params for a full catalog overview.',
 ...
 */
function handleToolLookup(toolName) {
 ...
 */
function handleGroupLookup(groupName) {
 ...
 */
function handleTaskSearch(task) {
 ...
 */
function handleCatalogOverview() {
...
//# sourceMappingURL=tool-guide.js.map