...
export const NamespaceConfigSchema = z.object({
    ...
    recall: z.array(z.string().min(1).max(63).regex(NAMESPACE_PATTERN, {
        message: 'namespace must be lowercase alphanumeric with dots, hyphens, underscores; must start with letter or digit',
 ...
 */
export function resolveNamespaceConfig(configNamespace, agentId) {
...
const SECRET_FIELDS = ['apiKey', 'twilioAccountSid', 'twilioAuthToken', 'twilioPhoneNumber', 'postmarkToken'];
/**
