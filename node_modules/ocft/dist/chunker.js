...
export async function getFileInfo(filePath, chunkSize = DEFAULT_CHUNK_SIZE) {
...
export async function* readAllChunks(filePath, chunkSize = DEFAULT_CHUNK_SIZE) {
    const data = await readFile(filePath);
...
export class ChunkAssembler {
    ...
    totalChunks;
    outputPath;
    constructor(outputPath, expectedHash, totalChunks) {
        this.outputPath = outputPath;
        this.expectedHash = expectedHash;
        this.totalChunks = totalChunks;
    }
    // Add a chunk
    addChunk(index, data, expectedChunkHash) {
